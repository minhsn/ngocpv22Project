...
public class ElasticService {
    public static void main(String[] args) throws IOException {
        System.out.println(getSuggestion("hạ l"));
    }
    public static List<String> getSuggestion(String input) throws IOException {
        ClientConfiguration clientConfiguration =
                ClientConfiguration.builder().connectedTo("10.140.0.8:9200").build();
        ...
        SearchRequest searchRequest = new SearchRequest("title_suggest_ngoc");
